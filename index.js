...
// Update: Fixed Mobile Modal clipping (top-align), Added Draggable Modal Header
...
function injectCustomStyles() {
    ...
    const css = `
        ...
        #img-router-modal-overlay { 
            ...
            overflow-y: auto;
            padding-top: 60px; /* 避开顶部栏 */
            padding-bottom: 60px;
        }
        #img-router-modal-overlay.active { display: flex; }
        ...
        .img-router-header { border-bottom: 1px solid rgba(255,255,255,0.1); margin-bottom: 15px; padding-bottom: 10px; cursor: move; /* 提示可拖拽 */ }
...
function initModalDrag() {
    ...
    function handleStart(e) {
        // 仅允许拖拽标题栏
        if (e.target.closest('button')) return; // 排除关闭按钮
        ...
        const currentTranslate = getTranslateValues(modal);
            ...
            <div id="img-router-modal">
                ...
                <div id="img-router-modal-content" style="padding: 15px;">
                    <div class="img-router-header">
                        <h3 style="margin:0;">🎨 图像生成器 <span style="font-size:0.6em; opacity:0.7;">v2.0.0</span></h3>
