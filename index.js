...
jQuery(async () => {
    ...
    const fab = $(`
        <button id="img-router-fab" title="图像生成器">
    ...
    const modalOverlay = $(`
        <div id="img-router-modal-overlay">
    ...
    // Move settings panel content into modal
    $('#img-router-modal-content').append($('#img-router-settings'));
    ...
    $('#img-router-modal-close').on('click', function() {
