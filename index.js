...
// Update: Fixed Mobile UI positioning, Z-Index issues, and Modal centering
...
function injectCustomStyles() {
    ...
    const css = `
        ...
        /* Modal Overlay - 强制全屏覆盖，最高层级 */
        #img-router-modal-overlay { 
            position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
            background: rgba(0,0,0,0.6); backdrop-filter: blur(3px); 
            z-index: 2147483646; /* 仅次于 FAB */
            display: none; 
            /* 关键：使用 Flex 居中，兼容移动端 */
            align-items: center; 
...
jQuery(async () => {
    try {
        ...
        // 关键修复：z-index 设为最大，bottom 定位避免被顶部遮挡
